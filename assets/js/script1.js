...
function showtasks() {
    ...
    taskobject.forEach((item,index) => {
        ...
        html += ` <div class="task">
        <div class="content">
            <input type="text " class="text" value="${item}" readonly>
        </div>
        <div class="actions">
            <button class="pinkedit" onclick="editfunc(${index})"> Edit </button>
...
function editfunc(index){
    ...
    let editbtn=document.querySelectorAll(".pinkedit");
    let webstorage = localStorage.getItem("storedtasks");
...
function deletefunc(index){
    ...
    let deletedbox=document.querySelectorAll(".text");
